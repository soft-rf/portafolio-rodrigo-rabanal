...
const HighlightedSkill = ({ text }) => {
  ...
  return (
    <span>
      {parts.map((part, i) => 
        highlights[part] ? <span key={i} className={highlights[part]}>{part}</span> : part
      )}
    </span>
  );
};
    ...
    <div className="App">
        ...
        <div className="profile-mission-container">
          <section className="profile">
            <div className="profile-pic-container">
              <img src={profilePic} className="profile-pic" alt="Rodrigo Rabanal Fernández" />
            </div>
          ...
          <div className="project-cards">
            <div className="card">
              <div className="card-content">
                ...
                <ul>
                  {c.projects.ecommerce.description.features.map((feature, index) => (
                    <li key={index}>{feature}</li>
                  ))}
                </ul>
              </div>
              <div className="card-links">
                <a href="https://somosbaristas.com" target="_blank" rel="noopener noreferrer">{c.projects.ecommerce.link} <FaChevronRight /></a>
                <a href="#" target="_blank" rel="noopener noreferrer">{c.projects.ecommerce.documentation} <FaChevronRight /></a>
              </div>
            </div>
            <div className="card">
              <div className="card-content">
                ...
                <ul>
                  {c.projects.duroPisos.description.features.map((feature, index) => (
                    <li key={index}>{feature}</li>
                  ))}
                </ul>
              </div>
              <div className="card-links">
                <a href="https://rodrigofernandezqa.github.io/duropisos/" target="_blank" rel="noopener noreferrer">{c.projects.duroPisos.link} <FaChevronRight /></a>
                <a href="#" target="_blank" rel="noopener noreferrer">{c.projects.duroPisos.documentation} <FaChevronRight /></a>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="skills-list">
              ...
              <ul>
                {c.skills.technical.map((skill, index) => (
                  <li key={index}><HighlightedSkill text={skill} /></li>
                ))}
              </ul>
            </div>
      ...
      <footer id="contact" className="footer">
        ...
        <div className="contact-links">
          <a href={`mailto:${c.contact.email}`} aria-label="Email"><FaEnvelope /></a>
          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><FaLinkedin /></a>
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><FaGithub /></a>
        </div>
        <p>{c.contact.soft}</p>
